...
// 临时素材
      ...
      // dd($result);
        ...
        $info = [
            ...
            'protocol' => 'http://mmbiz.qpic.cn/mmbiz_png/UXdJKykR18DLPDI1F14ErjAJzbGOmhTchNTgOhGOvswzribcjIz9rUVfiah5icHvKj2CTFKJQzUyJ5fpqGlDRsNww/0?wx_fmt=png',
            'end_time' => '1438990559',
            'primary_category_id' => 1,
            'secondary_category_id' => 101,
            'agreement_media_id' => '61PIGeJ-fTqkonfHNWsob8To-TDU85-olgjMyfddjO0',
            'operator_media_id' => '61PIGeJ-fTqkonfHNWsob8To-TDU85-olgjMyfddjO0',
            'app_id' => '',
        ];

        $result = $card->sub_merchant->create($info);
        dd($result);

        //设置白名单
        $openids = ['o1HzZvxctE9WLc271wa1ds3UM78s'];
  ...
  piby4vce3AtaPu6cIhBHkt6IjlkY9YnDsfw/0"
        ...
        $req = "%3C%3Fxml+version%3D%221.0%22+encoding%3D%22GBK%22+standalone%3D%22yes%22%3F%3E%3Cxml%3E%3Ccurr_type%3ECNY%3C%2Fcurr_type%3E%3Cins_cd%3E08A9999999%3C%2Fins_cd%3E%3Cmchnt_cd%3E0002900F0370542%3C%2Fmchnt_cd%3E%3Cmchnt_order_no%3EaliQR20190419132925120258330%3C%2Fmchnt_order_no%3E%3Corder_amt%3E1%3C%2Forder_amt%3E%3Corder_type%3EFWC%3C%2Forder_type%3E%3Crandom_str%3EHLUNFRHTIYBUZEYQT3LOKRTGFM4X0GAO%3C%2Frandom_str%3E%3Creserved_addn_inf%3E%3C%2Freserved_addn_inf%3E%3Creserved_bank_type%3EPCREDIT%3C%2Freserved_bank_type%3E%3Creserved_buyer_logon_id%3Edmk***%40ccmknt.com%3C%2Freserved_buyer_logon_id%3E%3Creserved_channel_order_id%3EaliQR20190419132925120258330%3C%2Freserved_channel_order_id%3E%3Creserved_coupon_fee%3E%3C%2Freserved_coupon_fee%3E%3Creserved_fund_bill_list%3E%5B%7B%22amount%22%3A%220.01%22%2C%22fundChannel%22%3A%22PCREDIT%22%7D%5D%3C%2Freserved_fund_bill_list%3E%3Creserved_fy_settle_dt%3E20190419%3C%2Freserved_fy_settle_dt%3E%3Creserved_fy_trace_no%3E910000091046%3C%2Freserved_fy_trace_no%3E%3Creserved_is_credit%3E1%3C%2Freserved_is_credit%3E%3Creserved_settlement_amt%3E1%3C%2Freserved_settlement_amt%3E%3Cresult_code%3E000000%3C%2Fresult_code%3E%3Cresult_msg%3ESUCCESS%3C%2Fresult_msg%3E%3Csettle_order_amt%3E1%3C%2Fsettle_order_amt%3E%3Csign%3EIrDTKvKnhDjgPySFrNt2gam%2BlVGN2mUEde8bA4aB4Dm6h6%2FO%2F6XAw4vC1Hfmin5oEIuAeHBWDTeiTcmRSz5BKnCOCCqhvr5HeYdnpcVmEgVe3CwKKHC0Uue0cymL9kzkrclQemt5xQs6QAV6eB0dxGn132hWo%2FRsvhs4dpAR%2Fec%3D%3C%2Fsign%3E%3Cterm_id%3E%3C%2Fterm_id%3E%3Ctransaction_id%3E2019041922001417661028437934%3C%2Ftransaction_id%3E%3Ctxn_fin_ts%3E20190419132928%3C%2Ftxn_fin_ts%3E%3Cuser_id%3E2088802043117668%3C%2Fuser_id%3E%3C%2Fxml%3E";

        $resultXml = URLdecode($req);
        ...
        $data = ['ins_cd' => '08A9999999',
            ...
            'goods_des' => '2018121218035135813309',
            'mchnt_order_no' => time(),
            'order_amt' => 1,
            'auth_code' => '285778587333771179',
