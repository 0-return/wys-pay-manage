...
class PayController extends BaseController
{
    ...
    public $order_query = "https://fundwx.fuiou.com/micropay";
    ...
    public function qr_submit($data)
    {
        try {
            ...
            $request['curr_type'] = "";
            $request['limit_pay'] = "";
            $request['openid'] = isset($data['openid']) ? $data['openid'] : "";
            $request['sub_openid'] = "";
            $request['sub_appid'] = "";
    ...
    public function get_openid($data)
    {
        try {
            ...
            $request = [
                'ins_cd' => isset($data['ins_cd']) ? $data['ins_cd'] : '',//机构号
                'mchnt_cd' => isset($data['mchnt_cd']) ? $data['mchnt_cd'] : '',//商户号
                'redirect_uri' => isset($data['redirect_uri']) ? $data['redirect_uri'] : url('/api/fuiou/weixin/pay_view'),
            ...
            $str = $obj->getSignContent($request);
            $request['sign'] = $obj->sign($str, $pem);
            dd('https://fundwx.fuiou.com/oauth2/getOpenid?sign='.$request['sign'].$str);
