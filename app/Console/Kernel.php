...
use App\Console\Commands\RealTimeQueryFlow;
...
class Kernel extends ConsoleKernel
{
    ...
    protected function schedule(Schedule $schedule)
    {
        ...
        $schedule->command('jd-audit')->everyMinute();
        $schedule->command('newland-audit')->everyMinute();
        $schedule->command('flow')->everyMinute();
